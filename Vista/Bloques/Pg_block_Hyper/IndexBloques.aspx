...
<html>
	...
	<body class="is-preload">
		...
		<!-- Sidebar -->
			<section id="sidebar">
				<button onclick="window.location.href='/Vista/Main/Pg_Main_Eterna/Eterna/index.html'" class="btn">Patrones</button>
						...
						<section>
							...
							<div class="content">
								<div class="inner">
									...
									<ul class="actions">
										<li><a href="VerMas.html" class="button">Mas informacion</a></li>
									</ul>
								</div>
							</div>
						</section>
