<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="indexMain.aspx.vb" Inherits="Politech.indexMain" %>
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="index.html">Poli-Tech</a></h1>
        
      </div>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active" href="indexMain.aspx">Home</a></li>
    ...
    <section id="featured" class="featured">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="icon-box"> 
         <a href="/Vista/Bloques/Pg_block_Hyper/indexBloques.aspx"><img src="assets/img/Bloque.png" width="99%" alt=""></a>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <a href="/Vista/Mosaico/Pg_Mos_Phantom/indexMosaico.aspx"><img src="assets/img/Mosaico.png" width="99%" alt=""></a>
              </div>
          </div>
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <a href="/Vista/Pantalla Dividida/Pg_PDiv_Agency/startbootstrap-agency-gh-pages/indexPantallaDiv.aspx">Pantalla Dividida</a>
              </div>
          </div>
        </div>
