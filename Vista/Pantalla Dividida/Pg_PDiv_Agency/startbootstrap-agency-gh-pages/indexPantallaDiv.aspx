<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="indexPantallaDiv.aspx.vb" Inherits="Politech.indexPantallaDiv" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a  class ="nav-link"href="/Vista/Main/Pg_Main_Eterna/Eterna/index.html">Patrones</a></li>    
                    </ul>
                </div>
            </div>
        </nav>
